      ...
      <div className="container">
        <div className="card">
          ...
          <p>
            ...
            <button className="link-btn" onClick={() => setIsLogin(!isLogin)}>{isLogin ? 'Register' : 'Login'}</button>
          </p>
    ...
    <div className="container">
      ...
      <div className="tree-container">
        ...
        {user?.profileComplete === 100 && (
          <div className="celebration">PROFILE DONE! Your tree is fully grown!</div>
        )}
      </div>
      ...
      {!isEditing ? (
        <div className="profile-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h3>Your Profile</h3>
            <button className="edit-btn" onClick={() => { setIsEditing(true); setProfileData(user); }}>Edit Profile</button>
          </div>
        ...
        <div className="profile-card">
          ...
          <form onSubmit={updateProfile}>
            ...
            <input type="text" placeholder="Branch" value={profileData.branch || ''} onChange={(e) => setProfileData({ ...profileData, branch: e.target.value })} />
            <input type="number" placeholder="Year" value={profileData.year || ''} onChange={(e) => setProfileData({ ...profileData, year: e.target.value })} />
